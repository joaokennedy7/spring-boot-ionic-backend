...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Produto p3 = new Produto(null, "Mouse", 80.800);
        ...
        cli1.getTelefones().addAll(Arrays.asList("56745386", "56785486"));
        ...
        ItemPedido ip3 = new ItemPedido(ped2, p2, 100.00, 3, 800.00);
